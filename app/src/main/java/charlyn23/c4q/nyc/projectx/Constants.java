...
public class Constants {
    ...
    public static final String BODY_COMMENT = "body comment";
    ...
    public static final String THROW_SOMETHING = "throw something";
    public static final String SPIT = "spit";
    public static final String PULL_AT_CLOTHING = "pull at clothing";
    public static final String SEXUALLY_ASSAULTED = "sexual assaulted";
    public static final String FOLLOW = "follow";
    public static final String EXPOSE_THEMSELVES = "expose themselves";
    public static final String MASTURBATE = "masturbate";
    public static final String BARELY_NOTICED = "barely noticed";
